...
default_checkpoints = default_artifacts / "checkpoints"
if not default_checkpoints.exists() and default_artifacts.exists():
    os.environ.setdefault("STROKE_PRETRAINED_DIR", str(default_artifacts))
    os.environ.setdefault("STROKE_MODEL_DIR", str(default_artifacts))

sys.path.append(str(PROJECT_ROOT / "src"))

from brainstroke.core.config import INFER_DIR  # noqa: E402
from brainstroke.inference import load_models  # noqa: E402
